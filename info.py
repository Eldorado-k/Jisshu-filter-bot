...
BOT_TOKEN = environ.get('BOT_TOKEN', '7683351056:AAGBq4vbYEsr8VAwSMJzRwwFA73Y_nGaQRc')
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7428552084').split()]
USERNAME = environ.get('USERNAME', "https://t.me/Kngcey") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002376378205'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/ZFlixTeam')
...
SHORTENER_API = environ.get("SHORTENER_API", "nJ0xMvXlLEhpVcJK2MjvU6Vxx6u2")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", 'shareus.io')
SHORTENER_API2 = environ.get("SHORTENER_API2", "nJ0xMvXlLEhpVcJK2MjvU6Vxx6u2")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", 'shareus.io')
SHORTENER_API3 = environ.get("SHORTENER_API3", "nJ0xMvXlLEhpVcJK2MjvU6Vxx6u2")
